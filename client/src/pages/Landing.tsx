  ...
  return (
    <div className="min-h-screen flex flex-col surface-ground font-comfortaa">
      <header className="w-full surface-card border-b border-gray-800 shadow-sm py-3 px-4 md:px-12 flex justify-end items-center z-50">
        ...
        <div className="flex flex-col items-center gap-6">
            ...
            <div className="flex flex-col gap-2">
                <h1 className="text-5xl md:text-7xl font-black tracking-tighter  italic m-0 leading-tight">
                    {t('landing.title')} <br />
      ...
      <div className="flex-grow flex items-center justify-center p-6 py-16">
          <Card className="w-full max-w-[550px] shadow-8 border-1 border-gray-800 px-4 md:px-10 py-8 rounded-3xl bg-surface-card overflow-hidden">
            <div className="flex flex-col items-center gap-10">
                
                <form onSubmit={handleLogin} className="w-full flex flex-col gap-8 text-left p-fluid">
                    <div className="flex flex-col gap-4">
                        <label htmlFor="username" className="font-black text-xs text-gray-400 pl-1">{t('landing.username')}</label>
                        <InputText 
                            id="username" 
                            value={username} 
                    ...
                    <div className="flex flex-col gap-4">
                        <label htmlFor="password" title="password" className="font-black text-xs text-gray-400 pl-1">{t('landing.password')}</label>
                        <Password 
                            id="password" 
                            value={password} 
                    ...
                    <Button label={t('landing.signin')} icon="pi pi-sign-in" className="py-4 font-black  tracking-widest shadow-6 rounded-xl" />
